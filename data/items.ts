export const Items = [{
  ...
  "language": {
    ...
    "description": [
      "<h1>Passive: Pierce</h1>Grants each attack a 30% chance to pierce through evasion and deal 70 bonus magical damage.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Chop Tree</h1> Destroy a target tree. <br><br>Cast Range: 350",
      "",
      "<h1>Passive: Quell</h1> Increases attack damage against non-hero units by 8 for melee heroes, and 4 for ranged.",
    ],
  ...
  "language": {
    ...
    "description": [
      "<h1>Use: Plant Tree</h1> Targets the ground to plant a happy little tree that lasts for 20 seconds.<br><br>Range: 400",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "description": [
      "<h1>Passive: Lifesteal</h1>Heals the attacker for a percentage of attack damage dealt. Lifesteal from creeps is reduced by %creep_lifesteal_reduction_pct%%%.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Reveal</h1> Gives True Sight over a %active_radius% radius revealing wards and units even in Fog of War.",
  ...
  "components": [{ "itemIndex": 1, "componentId": 34 }, {
    "itemIndex": 2,
    "componentId": 16,
  }, { "itemIndex": 3, "componentId": 16 }],
  "isInNeuralNetwork": false,
  "isFullItemHeroPurchaseItem": false,
}, {
  "id": 36,
  ...
  "language": {
    ...
    "description": [
      "<h1>Use: Replenish</h1> Grants 6 mana regeneration to the target for 25 seconds.<br><br>If the unit is attacked by an enemy hero or Roshan, the effect is lost.<br><br>Range: 250",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "description": [
      "<h1>Use: Salve</h1> Grants 30 health regeneration to the target for 13 seconds.<br><br>If the unit is attacked by an enemy hero or Roshan, the effect is lost.<br><br>Heals for half the amount when cast on an ally.<br><br>Range: 250",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Regenerate</h1>Consumes a charge to restore 110 health and 60 mana over 2.7 seconds. If the hero is attacked by an enemy hero or Roshan, the effect is lost.<br><br>The Bottle automatically refills at the fountain.<br><br>Hold Control to use on an allied hero.<br><br>Range: 350",
      "",
  ...
  "language": {
    ...
    "description": [
      "<h1>Use: Plant</h1>Plants an Observer Ward, an invisible watcher that gives ground vision in a %vision_range_tooltip% radius to your team. Lasts %duration_minutes_tooltip% minutes.<br><br>Hold Control to give one Observer Ward to an allied hero.<br><br>Range: %abilitycastrange%",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "description": [
      "<h1>Use: Devour</h1> Consumes a target tree to gain 7.0 health regeneration for 16.0 seconds. Consuming an Ironwood Tree doubles the heal amount.<br><br>Comes with 3 charges.  Can be used on an allied hero to give them one Tango.<br><br>Tree Range: 165",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "components": [{ "itemIndex": 1, "componentId": 29 }],
  "isInNeuralNetwork": false,
  "isFullItemHeroPurchaseItem": false,
}, {
  "id": 48,
  ...
  "language": {
    ...
    "description": [
      "<h1>Upgrade: Town Portal Scroll</h1>Upgrades your Town Portal Scroll, allowing it to target units, reduces cooldown and does not consume a charge on usage. ",
      "Movement speed bonuses from multiple pairs of boots do not stack.",
    ],
    "notes": [],
    "attributes": [],
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Phase</h1> Gives %phase_movement_speed%%% increased movement speed on melee heroes, and %phase_movement_speed_range%%% on ranged heroes, and lets you move through units and turn more quickly for %phase_duration% seconds.",
      "Movement speed bonuses from multiple pairs of boots do not stack.",
    ],
    "notes": [],
    "attributes": [],
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Switch Attribute</h1>Switches between +%bonus_stat% Strength, +%bonus_stat% Agility, or +%bonus_stat% Intelligence.",
      "Movement speed bonuses from multiple pairs of boots do not stack.",
    ],
    "notes": [
  ...
  "components": [{ "itemIndex": 1, "componentId": 25 }],
  "isInNeuralNetwork": false,
  "isFullItemHeroPurchaseItem": false,
}, {
  "id": 65,
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Transmute</h1> Kills a non-hero target for 160 gold and 2.1x experience. When used on a neutral creep, guarantees to create a neutral item if available. <br><br> Cannot be used on Ancient creeps.<br><br>Range: 600",
    ],
    "notes": [
  ...
  "components": [{ "itemIndex": 1, "componentId": 10 }, {
    "itemIndex": 2,
    "componentId": 28,
  }, { "itemIndex": 3, "componentId": 19 }],
  "isInNeuralNetwork": false,
  "isFullItemHeroPurchaseItem": false,
}, {
  "id": 67,
  ...
  "components": [{ "itemIndex": 1, "componentId": 56 }, {
    "itemIndex": 2,
    "componentId": 57,
  }],
  "isInNeuralNetwork": false,
  ...
  "language": {
    ...
    "description": [
      "<h1>Passive: Damage Block</h1>Gives a 100% chance to block 30 damage from incoming attacks on melee heroes, and 20 damage on ranged.<br><br>Has a 50% chance to block damage from creeps.",
    ],
  ...
  "components": [{ "itemIndex": 1, "componentId": 20 }, {
    "itemIndex": 2,
    "componentId": 13,
  }],
  "isInNeuralNetwork": false,
  ...
  "language": {
    ...
    "description": ["Doubles its bonuses after minute %clock_time%."],
    "notes": [],
    "attributes": [],
  },
  "stat": {
  ...
  "components": [{ "itemIndex": 1, "componentId": 94 }, {
    "itemIndex": 2,
    "componentId": 4,
  }],
  "isInNeuralNetwork": false,
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Restore</h1>Restores %heal_amount% health to allied units in a %heal_radius% radius.",
      "",
  ...
  "components": [
    { "itemIndex": 1, "componentId": 86 },
    { "itemIndex": 2, "componentId": 88 },
    { "itemIndex": 3, "componentId": 26 },
    { "itemIndex": 4, "componentId": 2 },
  ],
  "isInNeuralNetwork": false,
  "isFullItemHeroPurchaseItem": false,
}, {
  ...
  "components": [{ "itemIndex": 1, "componentId": 12 }],
  "isInNeuralNetwork": false,
  "isFullItemHeroPurchaseItem": false,
}, {
  "id": 86,
  ...
  "language": {
    ...
    "description": [
      "<h1>Passive: Buckler Aura</h1> Grants 2 armor to allied player units.<br><br>Radius: 1200",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "components": [{ "itemIndex": 1, "componentId": 28 }],
  "isInNeuralNetwork": false,
  "isFullItemHeroPurchaseItem": false,
}, {
  "id": 88,
  ...
  "language": {
    ...
    "description": [
      "<h1>Passive: Basilius Aura</h1>Grants 1.0 mana regeneration to allies.  <br><br>Radius: 1200",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "components": [{ "itemIndex": 1, "componentId": 31 }, {
    "itemIndex": 2,
    "componentId": 94,
  }, { "itemIndex": 3, "componentId": 56 }],
  "isInNeuralNetwork": false,
  "isFullItemHeroPurchaseItem": false,
}, {
  "id": 90,
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Barrier</h1>Gives a magic damage barrier that absorbs %barrier_block% damage to all nearby allies. Lasts %barrier_duration% seconds.<br><br>Radius: %barrier_radius%",
      "",
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Soul Release</h1> Provides 30 health regeneration when cast on allies, and deals 25 damage per second when cast on enemies. <br><br>Lasts 8.0 seconds.  <br><br>Gains charges every time an enemy hero dies within 1400 units.  Only the closest Urn to the dying hero will gain a charge.<br><br>Cast Range: 750",
    ],
    "notes": [
  ...
  "components": [{ "itemIndex": 1, "componentId": 27 }],
  "isInNeuralNetwork": false,
  "isFullItemHeroPurchaseItem": false,
}, {
  "id": 94,
  ...
  "language": {
    ...
    "description": [
      "<h1>Passive: Regeneration Aura</h1>Grants 2.0 health regeneration to allies.<br><br>Radius: 1200",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "components": [{ "itemIndex": 1, "componentId": 58 }, {
    "itemIndex": 2,
    "componentId": 24,
  }, { "itemIndex": 3, "componentId": 57 }],
  "isInNeuralNetwork": false,
  "isFullItemHeroPurchaseItem": false,
}, {
  "id": 96,
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Hex</h1>Turns a target unit into a harmless critter for %sheep_duration% seconds. The target has a base movement speed of %sheep_movement_speed% and will be silenced, muted, and disarmed.<br>Instantly destroys illusions.<br><br>Range: %abilitycastrange%",
    ],
    "notes": [
  ...
  "components": [{ "itemIndex": 1, "componentId": 485 }, {
    "itemIndex": 2,
    "componentId": 23,
  }, { "itemIndex": 3, "componentId": 1125 }],
  "isInNeuralNetwork": false,
  "isFullItemHeroPurchaseItem": false,
}, {
  "id": 98,
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Soul Burn</h1>Silences the target unit for %silence_duration% seconds. At the end of the silence, %silence_damage_percent%%% of the damage received while silenced is inflicted as bonus magical damage.<br><br>Range: %abilitycastrange%",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "components": [{ "itemIndex": 1, "componentId": 23 }, {
    "itemIndex": 2,
    "componentId": 57,
  }, { "itemIndex": 3, "componentId": 244 }],
  "isInNeuralNetwork": false,
  "isFullItemHeroPurchaseItem": false,
}, {
  "id": 100,
  ...
  "language": {
    ...
    "description": [
      '<h1>Active: Cyclone</h1> Sweeps a target unit up into a cyclone, making them invulnerable for 2.5 seconds. Cyclone can only be cast on enemy units or yourself.<br><br>Enemy units take 50 magical damage upon landing.<br><br>Range: 550<br>Dispel Type: <span class=\\"GameplayValues GameplayVariable\\">Basic Dispel</span>',
    ],
    "notes": [
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Force</h1>Pushes any target unit %push_length% units in the direction it is facing. <br><br>Range: %abilitycastrange%",
    ],
    "notes": [
  ...
  "components": [{ "itemIndex": 1, "componentId": 1122 }, {
    "itemIndex": 2,
    "componentId": 473,
  }],
  "isInNeuralNetwork": false,
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Energy Burst</h1> Emits a powerful burst of magical damage upon a targeted enemy unit. Heals the caster %dagon_spell_lifesteal%%% of damage dealt by Dagon. Upgradable.<br><br>Damage: %damage%<br>Range: %abilitycastrange%<br>Mana Cost: %mana_cost_tooltip%",
    ],
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Demonic Summoning</h1>Summons a Warrior and an Archer to fight for you for 60 seconds.<br><br><h1>Warrior:</h1>Burns mana every hit, and deals magical damage to whoever kills it.  Gains True Sight at level 3.<br>Health: 800 / 1200 / 1600<br>Damage: 25 / 45 / 65<br>Mana Break Damage: 30 / 40 / 50<br>Last Will Damage: 600 / 700 / 800<br><br><h1>Archer:</h1>Has a passive movement and attack speed aura. Gains Purge at Level 3.<br>Health: 800 / 1200 / 1600<br>Damage: 37 / 57 / 75<br>Aura Move Speed: 5 / 7 / 9<br>Aura Radius: 1200",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "components": [
    { "itemIndex": 1, "componentId": 60 },
    { "itemIndex": 2, "componentId": 23 },
    { "itemIndex": 3, "componentId": 21 },
    { "itemIndex": 4, "componentId": 22 },
  ],
  "isInNeuralNetwork": false,
  "isFullItemHeroPurchaseItem": false,
}, {
  ...
  "components": [{ "itemIndex": 1, "componentId": 1125 }, {
    "itemIndex": 2,
    "componentId": 1125,
  }],
  "isInNeuralNetwork": false,
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Reset Cooldowns</h1>Resets the cooldowns of all your items and abilities. Shares a cooldown with Refresher Shard. This item's cooldown only progresses in your hero's main inventory.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "components": [{ "itemIndex": 1, "componentId": 9 }, {
    "itemIndex": 2,
    "componentId": 55,
  }, { "itemIndex": 3, "componentId": 86 }],
  "isInNeuralNetwork": false,
  "isFullItemHeroPurchaseItem": false,
}, {
  "id": 112,
  ...
  "language": {
    ...
    "description": [
      "<h1>Passive: Assault Aura</h1> Grants 30 attack speed and 5 armor to nearby allied units and structures, and decreases nearby enemy unit and structure armor by -5.<br><br>Radius: 1200",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "components": [{ "itemIndex": 1, "componentId": 61 }, {
    "itemIndex": 2,
    "componentId": 53,
  }],
  "isInNeuralNetwork": false,
  ...
  "components": [{ "itemIndex": 1, "componentId": 21 }, {
    "itemIndex": 2,
    "componentId": 8,
  }],
  "isInNeuralNetwork": false,
  ...
  "components": [{ "itemIndex": 1, "componentId": 473 }, {
    "itemIndex": 2,
    "componentId": 129,
  }],
  "isInNeuralNetwork": false,
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Bloodpact</h1> Increases Bloodstone's Spell Lifesteal by %lifesteal_multiplier%x and also converts the same percentage of damage dealt to mana. Lasts %buff_duration% seconds.",
    ],
    "notes": [
  ...
  "components": [{ "itemIndex": 1, "componentId": 24 }, {
    "itemIndex": 2,
    "componentId": 1125,
  }],
  "isInNeuralNetwork": false,
  ...
  "language": {
    ...
    "description": [
      "<h1>Passive: Spellblock</h1>Blocks most targeted spells once every %block_cooldown% seconds.",
      "",
      "<h1>Active: Transfer Spellblock</h1>Temporarily removes Spellblock from the item's owner and transfers it to an allied unit for %block_cooldown% seconds.<br><br>Range: %abilitycastrange%",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "description": [
      "<h1>Passive: Damage Block</h1> Grants a 60% chance to block 50 damage from incoming attacks on melee heroes, and 25 damage on ranged.",
    ],
    "notes": ["Multiple sources of damage block do not stack."],
    "attributes": [],
  },
  ...
  "components": [{ "itemIndex": 1, "componentId": 3 }, {
    "itemIndex": 2,
    "componentId": 4,
  }],
  "isInNeuralNetwork": false,
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Damage Return</h1>For 5.5 seconds, the damage returned from all sources is increased by 85%.",
      "",
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Barrier</h1> Creates a spell shield that absorbs up to %barrier_block% magical damage.  Lasts %barrier_duration% seconds.",
    ],
    "notes": [
      "Stacks multiplicatively with other sources of spell resistance.",
    ],
  ...
  "components": [{ "itemIndex": 1, "componentId": 54 }, {
    "itemIndex": 2,
    "componentId": 51,
  }],
  "isInNeuralNetwork": false,
  ...
  "components": [{ "itemIndex": 1, "componentId": 51 }, {
    "itemIndex": 2,
    "componentId": 7,
  }, { "itemIndex": 3, "componentId": 485 }],
  "isInNeuralNetwork": false,
  "isFullItemHeroPurchaseItem": false,
}, {
  "id": 135,
  ...
  "language": {
    ...
    "description": [
      "<h1>Passive: Pierce</h1>Grants each attack a 80% chance to pierce through evasion and deal 70 bonus magical damage.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "description": [
      "<h1>Toggle: Burn</h1> When active, scorches enemies for %aura_damage% magical damage per second and causes them to miss %blind_pct%%% of their attacks. Illusions deal %aura_damage_illusions% magical damage per second.<br><br>Radius: %aura_radius%",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "components": [{ "itemIndex": 1, "componentId": 52 }, {
    "itemIndex": 2,
    "componentId": 32,
  }, { "itemIndex": 3, "componentId": 10 }],
  "isInNeuralNetwork": false,
  "isFullItemHeroPurchaseItem": false,
}, {
  "id": 139,
  ...
  "components": [{ "itemIndex": 1, "componentId": 149 }, {
    "itemIndex": 2,
    "componentId": 51,
  }],
  "isInNeuralNetwork": false,
  ...
  "language": {
    ...
    "description": [
      "<h1>Passive: Critical Strike</h1>Grants each attack a 30% chance to deal 225% damage.",
    ],
  ...
  "components": [{ "itemIndex": 1, "componentId": 8 }, {
    "itemIndex": 2,
    "componentId": 17,
  }],
  "isInNeuralNetwork": false,
  ...
  "components": [
    { "itemIndex": 1, "componentId": 3 },
    { "itemIndex": 2, "componentId": 5 },
    { "itemIndex": 3, "componentId": 1125 },
    { "itemIndex": 4, "componentId": 11 },
  ],
  "isInNeuralNetwork": false,
  "isFullItemHeroPurchaseItem": false,
}, {
  ...
  "language": {
    ...
    "description": [
      ...
      "",
      "<h1>Passive: Cleave</h1> Deals 70% of attack damage as physical damage in a cone up to 650 around the target. Deals 40% against creeps. (Melee Only)",
    ],
    "notes": [
  ...
  "components": [{ "itemIndex": 1, "componentId": 170 }, {
    "itemIndex": 2,
    "componentId": 24,
  }],
  "isInNeuralNetwork": false,
  ...
  "language": {
    ...
    "description": [
      '<h1>Active: Mirror Image</h1>Creates 2 images of your hero that last 20 seconds. <br><br>Melee images deal 33 damage, while Ranged images deal 28. Illusions take 300% damage. <br><br>Dispel Type: <span class=\\"GameplayValues GameplayVariable\\">Basic Dispel</span>',
    ],
    "notes": [
  ...
  "language": {
    ...
    "description": [
      "<h1>Passive: Critical Strike</h1>Grants each attack a 30% chance to deal 160% damage.",
    ],
    "notes": ["Critical Strike does not work against buildings."],
    "attributes": [],
  },
  ...
  "components": [{ "itemIndex": 1, "componentId": 6 }, {
    "itemIndex": 2,
    "componentId": 25,
  }, { "itemIndex": 3, "componentId": 2 }],
  "isInNeuralNetwork": false,
  ...
  "components": [{ "itemIndex": 1, "componentId": 26 }, {
    "itemIndex": 2,
    "componentId": 5,
  }, { "itemIndex": 3, "componentId": 53 }],
  "isInNeuralNetwork": false,
  "isFullItemHeroPurchaseItem": false,
}, {
  "id": 156,
  ...
  "language": {
    ...
    "description": [
      '<h1>Active: Unholy Rage</h1>Increases Lifesteal percentage to %unholy_lifesteal_total_tooltip%%% for %unholy_duration% seconds. <br><br>Dispel Type: <span class=\\"GameplayValues GameplayVariable\\">Basic Dispel</span> ',
      "",
      "<h1>Passive: Lifesteal</h1>Heals the attacker for a percentage of attack damage dealt. Lifesteal from creeps is reduced by %creep_lifesteal_reduction_pct%%%.",
    ],
    "notes": [],
  ...
  "components": [{ "itemIndex": 1, "componentId": 166 }, {
    "itemIndex": 2,
    "componentId": 55,
  }],
  "isInNeuralNetwork": false,
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Static Charge</h1>Places a charged shield on a target unit for %static_duration% seconds which has a %static_chance%%% chance to release a %static_damage% magical damage shocking bolt at a nearby attacker and %static_strikes% additional enemies.<br><br>Range: %abilitycastrange%",
      "",
  ...
  "language": {
    ...
    "description": [
      "<h1>Passive: Chain Lightning</h1>Grants a 30% chance on attack to release a bolt of electricity that leaps between 4 targets within a 650 radius, dealing 135 magical damage to each. Lightning proc pierces evasion.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "description": [
      "<h1>Passive: Corruption</h1> Your attacks reduce the target's armor by %corruption_armor% for %corruption_duration% seconds.",
      "",
  ...
  "components": [{ "itemIndex": 1, "componentId": 22 }, {
    "itemIndex": 2,
    "componentId": 18,
  }],
  "isInNeuralNetwork": false,
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Berserk</h1>Gives %berserk_bonus_attack_speed% attack speed and %berserk_bonus_movement_speed% movement speed, but reduces your armor by %berserk_armor_reduction% and silences you.  Lasts %berserk_duration% seconds.",
      "",
      "<h1>Passive: Lifesteal</h1>Heals the attacker for a percentage of attack damage dealt. Lifesteal from creeps is reduced by %creep_lifesteal_reduction_pct%%%.",
    ],
    "notes": [],
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Inhibit</h1> Targets an enemy, slowing it for %purge_slow_duration% seconds.<br><br>Range: %abilitycastrange%",
      "",
  ...
  "components": [{ "itemIndex": 1, "componentId": 259 }, {
    "itemIndex": 2,
    "componentId": 37,
  }],
  "isInNeuralNetwork": false,
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Sacrifice</h1> Consume %AbilityHealthCost% health to temporarily gain %mana_gain% mana.  Lasts %duration% seconds.<br><br>If the mana gained cannot fit in your mana pool, it creates a buffer of mana that will be used before your mana pool.",
    ],
    "notes": [
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Replenish Mana</h1>Restores 175 mana to all nearby allies.<br><br>Radius: 1200",
      "Movement speed bonuses from multiple pairs of boots do not stack.",
    ],
  ...
  "language": {
    ...
    "description": [
      "<h1>Passive: Poison Attack</h1>Poisons the target, dealing 2.0 magical damage per second and slowing movement by -13 if the equipped hero is melee, or by -4 if they are ranged. Lasts for 2.0 seconds.",
    ],
  ...
  "components": [{ "itemIndex": 1, "componentId": 215 }, {
    "itemIndex": 2,
    "componentId": 485,
  }, { "itemIndex": 3, "componentId": 3 }],
  "isInNeuralNetwork": false,
  "isFullItemHeroPurchaseItem": false,
}, {
  "id": 184,
  ...
  "components": [{ "itemIndex": 1, "componentId": 17 }, {
    "itemIndex": 2,
    "componentId": 19,
  }, { "itemIndex": 3, "componentId": 244 }],
  "isInNeuralNetwork": false,
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Endurance</h1> Consumes a charge and gives +%bonus_attack_speed_pct% attack speed and +%bonus_movement_speed_pct%%% movement speed to nearby allies for %duration% seconds. <br><br>Comes with %charges_tooltip% charges.<br><br>Radius: %radius%  ",
      "",
  ...
  "components": [{ "itemIndex": 1, "componentId": 4 }, {
    "itemIndex": 2,
    "componentId": 28,
  }, { "itemIndex": 3, "componentId": 240 }],
  "isInNeuralNetwork": false,
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Valor</h1> If cast on an ally, grants them the %armor_reduction% armor, and removing it from the caster. <br><br>If cast on an enemy, reduces %armor_reduction% armor on both the enemy and the caster. <br><br>Range: %abilitycastrange%<br><br>Duration: %duration%",
    ],
  ...
  "components": [{ "itemIndex": 1, "componentId": 88 }, {
    "itemIndex": 2,
    "componentId": 261,
  }],
  "isInNeuralNetwork": false,
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Magic Weakness</h1> Cast a %debuff_radius% radius blast that causes enemy heroes to take %spell_amp%%% increased damage from spells.<br><br>Range: %abilitycastrange%<br>Duration: %resist_debuff_duration% seconds. ",
      "",
  ...
  "components": [{ "itemIndex": 1, "componentId": 106 }, {
    "itemIndex": 2,
    "componentId": 105,
  }],
  "isInNeuralNetwork": false,
  ...
  "components": [{ "itemIndex": 1, "componentId": 193 }, {
    "itemIndex": 2,
    "componentId": 105,
  }],
  "isInNeuralNetwork": false,
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Purge</h1> Targets an enemy, dispelling buffs from the target and slowing it for %purge_slow_duration% seconds.<br><br>Range: %abilitycastrange%",
      "",
  ...
  "components": [{ "itemIndex": 1, "componentId": 104 }, {
    "itemIndex": 2,
    "componentId": 103,
  }],
  "isInNeuralNetwork": false,
  ...
  "components": [{ "itemIndex": 1, "componentId": 201 }, {
    "itemIndex": 2,
    "componentId": 103,
  }],
  "isInNeuralNetwork": false,
  ...
  "components": [{ "itemIndex": 1, "componentId": 202 }, {
    "itemIndex": 2,
    "componentId": 103,
  }],
  "isInNeuralNetwork": false,
  ...
  "components": [{ "itemIndex": 1, "componentId": 203 }, {
    "itemIndex": 2,
    "componentId": 103,
  }],
  "isInNeuralNetwork": false,
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Energy Burst</h1> Emits a powerful burst of magical damage upon a targeted enemy unit. Upgradable.<br><br>Damage: %damage%<br>Range: %abilitycastrange%<br>Mana Cost: %mana_cost_tooltip%",
    ],
    "notes": ["Instantly kills illusions."],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Energy Burst</h1> Emits a powerful burst of magical damage upon a targeted enemy unit.<br><br>Damage: %damage%<br>Range: %abilitycastrange%<br>Mana Cost: %mana_cost_tooltip%",
    ],
    "notes": ["Instantly kills illusions."],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Cripple</h1>Roots the target for 2.0 seconds.<br><br>Range: 1100",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "components": [{ "itemIndex": 1, "componentId": 143 }, {
    "itemIndex": 2,
    "componentId": 125,
  }],
  "isInNeuralNetwork": false,
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Overwhelm</h1> Stuns a target enemy unit for 1.6 seconds. <br><br>Pierces Spell Immunity.<br><br>Range: 150",
      "",
      "<h1>Passive: Bash</h1> Grants melee heroes a 25% chance on hit to stun the target for 1.2 seconds and deal 120 bonus physical damage.  Bash chance for ranged heroes is 10%.",
      "",
      "<h1>Passive: Damage Block</h1> Grants a 60% chance to block 70 damage from incoming attacks on melee heroes, and 35 damage on ranged.",
    ],
    "notes": [
  ...
  "components": [{ "itemIndex": 1, "componentId": 162 }, {
    "itemIndex": 2,
    "componentId": 32,
  }],
  "isInNeuralNetwork": false,
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Disarm</h1>Prevents a target from attacking for 3.0 seconds on melee targets, and 5.0 seconds on ranged targets.<br><br>Range: 650",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "description": [
      "<h1>Passive: Aquila Aura</h1>Grants %aura_mana_regen% mana regeneration and %aura_bonus_armor% armor to nearby allies.<br><br>Radius: %aura_radius%",
  ...
  "language": {
    ...
    "description": [
      "<h1>Passive: Break</h1> Whenever you attack a hero or are attacked by any unit, the bonus 14 HP regen is lost and the movement speed bonus is reduced to 40 for 13 seconds.",
      "Movement speed bonuses from multiple pairs of boots do not stack.",
    ],
    "notes": [],
    "attributes": [],
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Fade</h1>Grants invisibility to you or a target allied hero as long as the target unit remains still for up to %fade_duration%s.  <br><br>Has a %fade_time% second fade time, and breaks instantly upon moving. <br><br>There is no cooldown when using this item on yourself.<br><br>Range: %abilitycastrange%",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "description": [
      "<h1>Use: Eat Mango</h1> Instantly restores 100 mana.<br><br>Range: 400",
    ],
  ...
  "components": [{ "itemIndex": 1, "componentId": 43 }, {
    "itemIndex": 2,
    "componentId": 42,
  }],
  "isInNeuralNetwork": false,
  ...
  "components": [{ "itemIndex": 1, "componentId": 48 }, {
    "itemIndex": 2,
    "componentId": 47,
  }],
  "isInNeuralNetwork": false,
  ...
  "language": {
    ...
    "lore": ["Winged boots that grant omnipresence."],
    "description": [
      "<h1>Upgrade: Town Portal Scroll</h1>Upgrades your Town Portal Scroll, allowing it to target units and heroes, reduces cooldown, channel time and does not consume a charge on usage. ",
      "Movement speed bonuses from multiple pairs of boots do not stack.",
    ],
    "notes": [],
    "attributes": [],
  ...
  "components": [{ "itemIndex": 1, "componentId": 69 }, {
    "itemIndex": 2,
    "componentId": 9,
  }, { "itemIndex": 3, "componentId": 59 }],
  "isInNeuralNetwork": false,
  "isFullItemHeroPurchaseItem": false,
}, {
  "id": 222,
  ...
  "language": {
    ...
    "description": [
      '<h1>Active: Nullify</h1> Dispels the target and applies a debuff for 5.0 seconds. Continuously dispels the target.<br><br>Dispel Type: <span class=\\"GameplayValues GameplayVariable\\">Basic Dispel</span>',
    ],
  ...
  "language": {
    ...
    "description": [
      '<h1>Active: Echo Shell</h1>Applies a shield to the target unit for 6 seconds which re-casts most targeted spells back to their caster.<br><br>The shielded unit will still take damage from the spell. <br><br>Range: 900<br>Dispel Type: <span class=\\"GameplayValues GameplayVariable\\">Basic Dispel</span>',
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "components": [{ "itemIndex": 1, "componentId": 187 }, {
    "itemIndex": 2,
    "componentId": 261,
  }, { "itemIndex": 3, "componentId": 244 }],
  "isInNeuralNetwork": false,
  ...
  "components": [{ "itemIndex": 1, "componentId": 57 }, {
    "itemIndex": 2,
    "componentId": 57,
  }, { "itemIndex": 3, "componentId": 129 }],
  "isInNeuralNetwork": false,
  "isFullItemHeroPurchaseItem": false,
}, {
  "id": 229,
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Shine</h1>When cast on an ally, grants them %target_armor% armor, %target_attack_speed% attack speed, and %target_movement_speed%%% movement speed. When cast on an enemy, removes %target_armor% armor, %target_attack_speed% attack speed, and %target_movement_speed%%% movement speed.<br><br>Removes %target_armor% armor from the caster when used. <br><br>Range: %abilitycastrange%<br><br>Duration: %duration%",
    ],
  ...
  "components": [{ "itemIndex": 1, "componentId": 79 }, {
    "itemIndex": 2,
    "componentId": 180,
  }, { "itemIndex": 3, "componentId": 86 }],
  "isInNeuralNetwork": false,
  ...
  "language": {
    ...
    "description": [
      '<h1>Active: Mend</h1>Restores %replenish_health% health and %replenish_mana% mana to nearby allies, and removes most negative effects from the caster.<br><br>Radius: %replenish_radius%<br>Dispel Type: <span class=\\"GameplayValues GameplayVariable\\">Basic Dispel</span>',
      "",
      "<h1>Passive: Guardian Aura</h1> Grants %aura_health_regen% health regeneration and %aura_armor% armor to allied units. If an allied hero's health falls below %aura_bonus_threshold%%%, this is increased to %aura_health_regen_bonus% health regeneration and %aura_armor_bonus% armor. <br><br>Radius: %aura_radius% ",
      "Movement speed bonuses from multiple pairs of boots do not stack.",
    ],
    "notes": [
  ...
  "language": {
    ...
    "description": [
      "<h1>Passive: Aethereal Focus</h1> Increases targeted spell and item cast range.",
    ],
  ...
  "components": [{ "itemIndex": 1, "componentId": 59 }, {
    "itemIndex": 2,
    "componentId": 57,
  }],
  "isInNeuralNetwork": false,
  ...
  "language": {
    ...
    "description": [
      "<h1>Passive: Cooldown Reduction</h1>Reduces the cooldown time of all spells and items.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "components": [{ "itemIndex": 1, "componentId": 11 }, {
    "itemIndex": 2,
    "componentId": 12,
  }],
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Chop</h1>Targets a non-player enemy unit to remove 40% of its current HP.<br><br>If cast on a tree, instantly destroys it.<br><br>Unit Range: 350<br>Tree Range: 350",
    ],
  ...
  "language": {
    ...
    "lore": ["Om nom nom."],
    "description": [
      "<h1>Use: Devour</h1> Consumes a target tree to gain 7.0 health regeneration for 16.0 seconds. Consuming an Ironwood Tree doubles the heal amount.<br><br>Tree Range: 165",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Guard</h1> For %duration% seconds, grant nearby allied heroes and buildings a %block_chance_active%%% chance to block damage equal to %block_damage_active% plus %strength_pct%%% of the casters Strength value from each incoming attack.<br>Units may only be affected by Guard once every %tooltip_reapply_time% seconds.<br><br>Radius: %bonus_aoe_radius%",
      "",
  ...
  "components": [{ "itemIndex": 1, "componentId": 125 }, {
    "itemIndex": 2,
    "componentId": 6,
  }],
  "isInNeuralNetwork": false,
  ...
  "components": [{ "itemIndex": 1, "componentId": 98 }, {
    "itemIndex": 2,
    "componentId": 598,
  }],
  "isInNeuralNetwork": false,
  ...
  "components": [{ "itemIndex": 1, "componentId": 55 }, {
    "itemIndex": 2,
    "componentId": 55,
  }],
  "isInNeuralNetwork": false,
  ...
  "components": [{ "itemIndex": 1, "componentId": 152 }, {
    "itemIndex": 2,
    "componentId": 149,
  }],
  "isInNeuralNetwork": false,
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Soul Rend</h1> Silences a target for %silence_duration% seconds. At the end of the silence, an additional %silence_damage_percent%%% of all damage taken during the silence will be dealt to the target as magical damage.<br><br>All attacks on the silenced target will have True Strike.<br><br>Range: %abilitycastrange%",
      "",
      "<h1>Passive: Mage Slayer</h1>Places a debuff when you attack enemies, causing them to do %spell_amp_debuff%%% less spell damage for %duration% seconds.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Glimmer</h1> After a %initial_fade_delay% second delay, grants invisibility, %active_movement_speed% movement speed and a magic damage barrier that absorbs up to %barrier_block% damage to you or a target allied unit for %duration% seconds. <br><br>Range: %abilitycastrange%<br><br>Can be cast while channeling.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "description": [
      "<h1>Use: Reset Cooldowns</h1>Resets the cooldowns of all your items and abilities. Shares a cooldown with Refresher Orb. This item's cooldown only progresses in your hero's main inventory.",
    ],
  ...
  "components": [{ "itemIndex": 1, "componentId": 102 }, {
    "itemIndex": 2,
    "componentId": 236,
  }],
  "isInNeuralNetwork": false,
  ...
  "language": {
    ...
    "description": [
      "<h1>Passive: Magical Damage Block</h1> Consumes a charge to block 120 magic damage from damage instances over 75 damage. <br><br>Comes with 6 charges. When the charges are gone, the item disappears.",
    ],
  ...
  "components": [{ "itemIndex": 1, "componentId": 92 }, {
    "itemIndex": 2,
    "componentId": 61,
  }],
  "isInNeuralNetwork": false,
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Energy Charge</h1>Target an allied unit to instantly restore %restore_per_charge% health and mana per charge stored. <br><br>Max %max_charges% charges. Automatically gains a charge every %charge_gain_timer% seconds and whenever a visible enemy within %charge_radius% range uses an ability.",
      "",
      "<h1>Passive: Holy Blessing</h1>Amplifies heals you provide by %heal_increase%%%.",
      "",
      "<h1>Passive: Regeneration Aura</h1>Grants %aura_health_regen% health regeneration to allies.<br><br>Radius: %aura_radius%",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "components": [{ "itemIndex": 1, "componentId": 108 }],
  "isInNeuralNetwork": false,
  "isFullItemHeroPurchaseItem": false,
}, {
  "id": 271,
  ...
  "language": {
    ...
    "description": [
      "<h1>Passive: Magic Amp</h1> Reduces magic resistance of the attacked enemy by %magic_resistance_reduction%%%.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "description": [
      '<h1>Active: Force</h1>Dispels the user and pushes them 750 units in the direction they are facing.<br><br>Dispel Type: <span class=\\"GameplayValues GameplayVariable\\">Basic Dispel</span>',
      "",
  ...
  "language": {
    ...
    "description": [
      "<h1>Passive: Greater Corruption</h1> Your attacks reduce the target's armor by -10 for 7.0 seconds.",
    ],
    "notes": ["Armor reduction works on buildings."],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Reveal</h1> Reveal a target 800 area of the map for 6 seconds.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    "displayName": "Greater Faerie Fire",
    "lore": [],
    "description": ["<h1>Use: Imbue</h1> Instantly restores 250 health."],
    "notes": [],
    "attributes": [],
  },
  "stat": {
  ...
  "language": {
    ...
    "description": [
      "<h1>Passive: Echo Shield</h1> Block and reflect most targeted spells back to their caster once every 12.0 seconds.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "lore": [],
    "description": [
      "<h1>Use: Consume</h1> Restores 500 health and 250 mana to the target over 6 seconds.<br><br>If the unit is attacked by an enemy hero or Roshan, the effect is lost.<br><br>Range: 250",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "description": [
      "<h1>Use: Plant Tree</h1> Targets the ground to plant a happy little tree that lasts for 20 seconds.<br><br>Range: 800",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "description": [
      "<h1>Use: Consume</h1> Grants a target allied unit a permanent buff that provides +2.25 Health Regen and +1.25 Mana Regen.<br><br>Does not stack on the same unit.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "lore": [],
    "description": [
      "<h1>Use: Building Repair</h1> Targets a building, restoring 40 of it's health over 30 seconds. Also grants +10 armor during this period.<br><br> Range: 600",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "description": [
      "<h1>Passive: Silence Strike</h1> The next attack silences the hit enemy for 2.0 seconds.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "lore": [],
    "description": [
      "<h1>Active: Blink Strike</h1> Targets a unit to teleport to them. Knocks enemies back 250 distance and disables them for 1 second. <br><br>Range: 1600",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Skitter</h1> Grants you %bonus_movement_speed_active%%% bonus movement speed and free pathing for %duration% seconds. Walking over trees causes them to be destroyed.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "lore": [],
    "description": [
      "<h1>Use: Plant a Mango Tree</h1> Targets the ground to plant a mango tree that provides unlimited mango power. The tree generates Enchanted Mangoes every 60 seconds, and provides unobstructed vision in the area <br><br>Range: 200",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "description": [
      '<h1>Active: Flicker</h1> Dispells debuffs and blinks you in a random forward direction for a random distance between 200 and 600. If cast within 3 seconds of receiving player damage, it will blink in place.<br><br>Dispel Type: <span class=\\"GameplayValues GameplayVariable\\">Basic Dispel</span>',
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "description": [
      "<h1>Passive: Prescient Aura</h1> Lowers Scan cooldown by %scan_cooldown_reduction%%% . Increases attack range (Ranged only) and cast range of allies in a %aura_range% unit radius.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Replenish Mana</h1> Restores %mana_restore% mana to all nearby allies. <br><br> Radius: %radius%",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "description": [
      "<h1>Passive: Water Regen</h1> Provides you with 10 HP regen and 5 mana regen while in the river.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Dig</h1> Channel for %abilitychanneltime% second. <br>Can find a Bounty Rune, a Flask, an Enchanted Mango, or a Kobold.",
    ],
    "notes": [
  ...
  "language": {
    ...
    "description": [
      "<h1>Passive: Afterburn</h1> Causes attacks to burn the enemy, dealing 22 damage per second for 3 seconds. Affects buildings.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Life Essence</h1> Increases your current and max health by %health_gain% for %health_gain_duration% seconds.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "lore": [],
    "description": [
      "<h1>Active: Ensnare</h1> Ensnares the target enemy and yourself for 1.75 seconds.<br><br> Range: 600",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "description": [
      "<h1>Passive: Certain Strike</h1> Empowers your next attack with %bonus_damage% bonus magical damage and True Strike. <font color='#7d7d7d'>Ranged Attackers</font> have +%active_bonus_attack_range% bonus range for the attack.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "description": [
      ...
      "<h1>Passive: Illusion Mastery</h1>Increases outgoing damage of all units and illusions controlled by the hero by 6%.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "lore": [],
    "description": [
      "<h1>Active: Havoc</h1> Knocks back enemies in 400 range around you, slowing them by 50 for 3 seconds and dealing 175 + 1.5x your str as magical damage.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "lore": [],
    "description": [
      "<h1>Passive: Rejuvenate </h1> When the wearer's health falls below 20%, they will receive a hard dispel and be healed for 300 health.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "description": [
      "<h1>Passive: Knockback</h1> Knocks back enemies 50 distance and deals 50 pure damage with every attack.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "description": [
      "",
      "<h1>Active: Woodland Stride</h1> Create a path of trees behind you for 3 seconds. Trees last up to 15 seconds. ",
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Greater Demonic Summoning</h1> Summon 2 sets of Level 3 Necronomicon Units that last 75 seconds. Units have 100% more health and 75% more damage.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Dig</h1> Channel for %abilitychanneltime% second. <br>Always finds a Bounty Rune!",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Reset Cooldowns</h1> Reset the cooldown on all items (except Refresher Orb).",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "description": [
      "<h1>Passive: Greater Healing</h1> Amplifies the wearer's Regeneration, Healing, Lifesteal and Spell Lifesteal by %bonus_amp%%%.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Lesser Avatar</h1> Grants Spell Immunity for 2 seconds.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "description": [
      "<h1>Passive: Spell Lifesteal</h1>Spell damage dealt to enemy heroes is returned to the caster as health, regardless of spell damage type.  <br><br>Lifesteal reduced against creeps.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "description": [
      "<h1>Passive: Witch Blade</h1>Causes your next attack to apply a poison for 4 seconds, slowing by 25% and dealing 0.75x your intelligence as damage every second. This attack has True Strike.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "description": [
      "<h1>Passive</h1>Everytime you are attacked, you return 30 damage to heroes and 20 damage to creeps.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "lore": [],
    "description": [
      "<h1>Active</h1>Deals 125 damage to up to 2 random enemy units within 700.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "description": [
      "<h1>Passive: Corrosion</h1>Dealing 3 damage per second, reducing armor by 3, and slowing movement by 13 if the equipped hero is melee, or by 4 if they are ranged.<br><br>Lasts for 3 seconds.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Cloak</h1>Causes you to become invisible for 6 seconds.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "description": [
      "<h1>Passive: Immolate</h1>Burns enemy units for 45 damage per second. Illusions deal 30 damage per second.<br><br>Radius: 375",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "description": [
      "<h1>Passive: Lifesteal</h1>Heals the attacker for 7 HP on each attack.",
    ],
    "notes": [
  ...
  "language": {
    ...
    "lore": [],
    "description": [
      "<h1>Active: Rejuvenate</h1>Target an allied hero and restore 480 health over 12 seconds.<br><br>If the unit is attacked by an enemy hero or Roshan, the effect is lost.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "description": [
      "<h1>Passive: Bottled Lightning</h1> Zaps %max_targets% enemy targets within %range% range, dealing %damage% damage and a %slow%%% slow for %slow_duration% seconds. Strikes every %interval% seconds.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "components": [{ "itemIndex": 1, "componentId": 593 }, {
    "itemIndex": 2,
    "componentId": 28,
  }, { "itemIndex": 3, "componentId": 2 }],
  "isInNeuralNetwork": false,
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Overwhelming Blink</h1> Teleport to a target point up to 1200 units away.<br><br>After teleportation, all enemies in a 800 AoE have 50 movement speed slow and 50 attack speed slow for 6 seconds, and take damage equal to 100 + 150 of your strength. <br><br>Overwhelming Blink cannot be used for 3.0 seconds after taking damage from an enemy hero or Roshan.",
    ],
    "notes": [
      "Self-casting will cause you to teleport in the direction of your team's fountain.",
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Arcane Blink</h1> Teleport to a target point up to %blink_range% units away. <br><br>Arcane Blink cannot be used for %blink_damage_cooldown% seconds after taking damage from an enemy hero or Roshan.",
    ],
    "notes": [
      "Self-casting will cause you to teleport in the direction of your team's fountain.",
  ...
  "components": [{ "itemIndex": 1, "componentId": 1 }, {
    "itemIndex": 2,
    "componentId": 58,
  }],
  "isInNeuralNetwork": false,
  ...
  "language": {
    ...
    "description": [
      "<h1>Passive: Ability Upgrade</h1>Upgrades an existing ability or adds a new ability to your hero.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "components": [{ "itemIndex": 1, "componentId": 100 }, {
    "itemIndex": 2,
    "componentId": 58,
  }],
  "isInNeuralNetwork": false,
  ...
  "components": [{ "itemIndex": 1, "componentId": 164 }, {
    "itemIndex": 2,
    "componentId": 81,
  }],
  "isInNeuralNetwork": false,
  ...
  "language": {
    ...
    "description": [
      ...
      "",
      "<h1>Passive: Vladmir's Aura</h1>Grants %lifesteal_aura%%% lifesteal, %damage_aura%%% bonus damage, %mana_regen_aura% mana regeneration, and %armor_aura% armor to nearby allies.",
    ],
    "notes": [
  ...
  "language": {
    ...
    "lore": [],
    "description": [
      "<h1>Passive: Cleave</h1> Melee heroes deal 20% of attack damage as physical damage in a cone up to 650 around the target.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "description": [
      "<h1>Passive: Maim</h1>Each attack has a 25% chance to reduce enemy hero movement speed by 20 and attack speed by 60 for 3 seconds.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "components": [{ "itemIndex": 1, "componentId": 181 }, {
    "itemIndex": 2,
    "componentId": 240,
  }, { "itemIndex": 3, "componentId": 593 }],
  "isInNeuralNetwork": false,
  "isFullItemHeroPurchaseItem": false,
}, {
  "id": 653,
  ...
  "language": {
    ...
    "lore": [],
    "description": [
      "<h1>Active: Warhammer</h1>Deals 75 damage and reduces the target's armor by 3 for 6 seconds.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Psychic Push</h1>Pushes the target enemy unit away from you %push_length% distance.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "description": [
      "<h1>Passive: Ceremonial Aura</h1>Lowers enemy Status Resistance by %status_resistance%%% and Magic Resistance by %magic_resistance%%%.<br><br>Radius: %aura_radius%",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Shadows</h1>Target an enemy, ally or self. Causes the target to become untargetable but also silenced, muted and disarmed for %duration% seconds. Applies a Basic Dispel.",
      "",
  ...
  "language": {
    ...
    "description": [
      "<h1>Passive: Giant's Foot</h1>Can path over any terrain and deals 100% of your strength per second to units you are standing ontop of.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "lore": [],
    "description": [
      "<h1>Passive: Vengeance's Shadow</h1>Upon death, you spawn a strong-illusion that deals 100 damage and takes 150% damage. Can cast all basic spells. Illusion casts 30 seconds.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Whip</h1>Grants 18% movement speed when cast on allies, and slows by 18% when cast on enemies. Lasts 4 seconds.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "description": [
      "<h1>Passive: Quicksilver</h1>Grants you a bonus %bonus_movement%%% movement speed and %bonus_attack% attack speed anytime one of your abilities are on cooldown.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "description": [
      "<h1>Passive: Shroud</h1> Restores mana equal to %mana_restore_pct%%% of incoming enemy spell damage.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    "displayName": "Satchel",
    "lore": [],
    "description": ["Increases XP that you earn by 15%."],
    "notes": [],
    "attributes": [],
  },
  "stat": {
  ...
  "language": {
    ...
    "description": [
      "<h1>Passive: Endurance</h1>Whenever a debuff would be applied to the owner, grant %status_resistance%%% Status resistance for %duration% seconds.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    "displayName": "Brigand's Blade",
    "lore": [
      "An infamous assassin's blade stolen and smuggled out of White Spire after its owner's mysterious demise.",
    ],
    "description": [
      "<h1>Passive: Dark Mercy</h1>Your attacks deal %bonus_damage% more damage to enemies for each %missing_hp%%% HP they are missing.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Mega Shield</h1> Force Field Aura Grants %active_reflection_pct%%% Damage Reflection for 5 seconds.",
      "",
  ...
  "language": {
    "displayName": "Blast Rig",
    "lore": [
      "One of a set of custom rigs once worn by infamous road agents in the Outlands, its siblings have been lost to misfires and the various tides of time.",
    ],
    "description": [
      "<h1>Passive: Hair Trigger</h1> The next time you get attacked by a hero within %radius% range, explode dealing %damage% damage to all enemies within a %radius% radius and causing them to miss %blind_pct%%% of their attacks for %blind_duration% seconds.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    "displayName": "Fae Grenade",
    "lore": [
      "Those marked for death by the fae shine brightly to all manner of creatures in the shadow realm.",
    ],
    "description": [
      "<h1>Active: Shadow Brand</h1>Throws a Mark towards an enemy within %abilitycastrange% range applying a debuff that deals %dps% damage every second and provides vision of the unit for %duration% seconds.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    "displayName": "Witchbane",
    "lore": [
      "With ready access to test subjects, untold cruelties have been dreamed up and loosed upon the world from within the walls of the Tyler Estate.",
    ],
    "description": [
      '<h1>Active: Cleanse</h1>Dispel Target Enemy or Ally.<br><br>Dispel Type: <span class=\\"GameplayValues GameplayVariable\\">Basic Dispel</span>',
      "",
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Pig, Out!</h1>Turns your hero into a critter for 4 seconds and gives them +10% Movement Speed.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    "displayName": "Tumbler's Toy",
    "lore": [
      "An antique plaything found in the ruins of an Ozenja circus bazaar.",
    ],
    "description": [
      "<h1>Active: Vault</h1>Propels your hero forward %leap_distance% units. Tumbler's Toy gets disabled for 3 seconds if its owner receives damage from a player source.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    "displayName": "Voidwalker Scythe",
    "lore": ["Lore lore lorem ipsum."],
    "description": [
      "<h1>Passive: Swift Strike</h1>Every %attacks% attacks, deal %bonus_damage% with your next attack. That attack can't be evaded.",
      "<h1>Passive: Void Shift</h1>Every %attacks% attacks received, become untargettable for %buff_duration% seconds.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "description": [
      "<h1>Passive: Bash</h1> Grants melee heroes a %bash_chance_melee%%% chance on hit to stun the target for %bash_duration% seconds and deal %bonus_chance_damage% bonus physical damage.  Bash chance for ranged heroes is %bash_chance_ranged%%%.",
      "<h1>Passive: Tenderize</h1> Every Attack on an enemy will reduce their total attack speed by %weaken_per_hit%%% per hit. Lasts %weaken_duration% seconds.",
    ],
    "notes": [
  ...
  "components": [{ "itemIndex": 1, "componentId": 81 }, {
    "itemIndex": 2,
    "componentId": 60,
  }],
  "isInNeuralNetwork": false,
  ...
  "components": [{ "itemIndex": 1, "componentId": 534 }, {
    "itemIndex": 2,
    "componentId": 58,
  }],
  "isInNeuralNetwork": false,
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Phantom Province</h1>Increases attack speed by %active_attack_speed% and your next %number_of_attacks% attacks have True Strike and deal magic damage. Expires after %active_duration% seconds.<br><br> Can attack Ethereal units and deals no damage to Magic Immune targets.",
      "",
      "<h1>Passive: Witch Blade</h1> Causes your next attack to apply a poison for %slow_duration% seconds, slowing by %slow%%% and dealing %int_damage_multiplier%x your intelligence as damage every second. Can only trigger once every %passive_cooldown% seconds.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "lore": [],
    "description": [
      "<h1>Active: Predator's Gaze</h1> Reveal a target %active_radius% area of the map within %abilitycastrange% distance for %duration% seconds.",
      "",
      "<h1>Passive: True Sight</h1> Grants the ability to see invisible units and wards to any allied vision within %radius% range of its carrier. ",
      "",
      "<h1>Passive: Everlasting</h1><font color='#e03e2e'>Cannot be dropped. On Death it dissassembles and the gem drops on the floor.</font>",
    ],
    "notes": ["Disabled while on a courier."],
    "attributes": [],
  },
  ...
  "components": [{ "itemIndex": 1, "componentId": 214 }, {
    "itemIndex": 2,
    "componentId": 185,
  }],
  "isInNeuralNetwork": false,
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Endurance</h1> Gives +%bonus_attack_speed_pct% attack speed and +%bonus_movement_speed_pct%%% movement speed to nearby allies for %duration% seconds. For the first %bonus_ms_duration% seconds allies are immune to slows.<br><br> Radius: %radius%  ",
      "",
      "<h1>Passive: Swiftness Aura</h1>Grants %aura_movement_speed% movement speed to allies.  <br><br>Radius: %radius%",
    ],
    "notes": [],
  ...
  "language": {
    ...
    "lore": [],
    "description": [
      "<h1>Active: Draw Forth</h1> When targeting an enemy, fire a harpoon at them, that pulls you and the target closer together, up to %pull_distance_pct%%% of the distance between you and your target. If the caster is melee, the hero and target are always pulled to within melee distance of each other.",
      "",
      "<h1>Passive: Echo Strike</h1> Causes melee attacks to attack twice in quick succession. The double attacks apply a %movement_slow%%% movement slow for %slow_duration% seconds on each strike.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Verdurous Dale</h1>  Target the ground with a %radius% radius. Provides +%aura_health_regen% health regeneration to all allied units while they are in the area of effect. Lasts %duration% seconds.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "description": [
      "<h1>Passive: Hound</h1> Attacking from behind slows enemies by %slow_pct_melee%%% (%slow_pct_ranged%%% if Ranged) and deals %backstab_damage% more damage. Slow lasts %slow_duration% second(s).",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "description": [
      "<h1>Passive: Rites of Eloshar</h1>Each time the wearer is attacked, they gain a stack of %mana_regen% mana regen, up to %stack_limit% stacks. Stacks last for %stack_duration% seconds.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "lore": [],
    "description": [
      "<h1>Active: Ogre Seal Flop</h1> Flop forward like an ogre seal %max_bounces% times, dealing %flop_damage% damage and slowing enemies in a %radius% radius by %slow%%% for %slow_duration% second on each bounce. %leap_distance% bounce distance. ",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "lore": [],
    "description": [
      "<h1>Passive: Reciprocity </h1> When attacked, the hero counter-attacks a target within their attack range. %counter_cooldown%s Cooldown.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    "displayName": "Eye of the Vizier",
    "lore": [
      "The ring of a cunning court mage who imprisoned a cadre of enemies to serve as his personal mana reserve.",
    ],
    "description": [],
    "notes": [],
    "attributes": [],
  ...
  "language": {
    ...
    "description": [
      "<h1>Passive: Crackshot</h1> Ranged Only. The next attack fires projectiles that deal %proc_bonus_damage% bonus damage at %count% additional targets within attack range plus a %secondary_target_range_bonus% range bonus. Does not trigger attack modifiers.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    "displayName": "Dagger of Ristul",
    "lore": [
      "A sinister shiv that grants favor to those willing to stain its blade with a sacrifice of their own blood.",
    ],
    "description": [
      "<h1>Active: Imbrue</h1> Consume %health_sacrifice% health to temporarily gain %bonus_damage% damage. Lasts %duration% seconds.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "lore": [],
    "description": [
      "<h1>Active: Switch Attribute</h1>Switches between an additional +%bonus_stat_tooltip% <font color='#ff0000'>Strength</font>, +%bonus_stat_tooltip% <font color='#9acd32'>Agility</font>, or +%bonus_stat_tooltip% <font color='#87ceeb'>Intelligence</font>, and provides the bonuses corresponding with that parameter. ",
  ...
  "components": [{ "itemIndex": 1, "componentId": 50 }, {
    "itemIndex": 2,
    "componentId": 52,
  }],
  "isInNeuralNetwork": false,
  ...
  "language": {
    ...
    "lore": [],
    "description": [
      "<h1>Active: Glow</h1> When cast on an enemy, doubles incoming magic damage on them up to a threshhold of %barrier_block% magic damage.<br><br>Lasts %duration% seconds.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "components": [{ "itemIndex": 1, "componentId": 174 }, {
    "itemIndex": 2,
    "componentId": 51,
  }],
  "isInNeuralNetwork": false,
  ...
  "language": {
    ...
    "lore": [],
    "description": [
      "<h1>Active: Suppress</h1> If targeting an enemy, slows it for %enemy_effect_duration% seconds.<br><br> If targeting an ally, applies a basic dispel, increases their movement speed, and makes them unslowable for %ally_effect_duration% seconds.<br><br>Both movement speed reduction and increase start at %phase_movement_speed%%% and gradually decrease to 0% over the course of the buff duration.<br><br>Range: %abilitycastrange%",
      "",
      '<h1>Passive: Manabreak</h1>Each attack burns %feedback_mana_burn% mana from the target, and deals %damage_per_burn% physical damage per burned mana. <br><br>Burns %feedback_mana_burn_illusion_melee% mana per attack from melee illusions and %feedback_mana_burn_illusion_ranged% mana per attack from ranged illusions. <br><br>Dispel Type: <span class=\\"GameplayValues GameplayVariable\\">Basic Dispel</span>',
    ],
    "notes": [],
  ...
  "components": [
    { "itemIndex": 1, "componentId": 17 },
    { "itemIndex": 2, "componentId": 18 },
    { "itemIndex": 3, "componentId": 19 },
    { "itemIndex": 4, "componentId": 24 },
  ],
  "isInNeuralNetwork": false,
  "isFullItemHeroPurchaseItem": false,
}, {
  ...
  "components": [{ "itemIndex": 1, "componentId": 86 }, {
    "itemIndex": 2,
    "componentId": 88,
  }, { "itemIndex": 3, "componentId": 94 }],
  "isInNeuralNetwork": false,
  "isFullItemHeroPurchaseItem": false,
}, {
  "id": 1100,
  ...
  "language": {
    ...
    "lore": [],
    "description": [
      "<h1>Toggle: Switch</h1> When active, Increases allied armor, health regeneration and mana regeneration. When Switched, decreases enemy armor, health regeneration and mana regeneration by the same amount.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "components": [{ "itemIndex": 1, "componentId": 252 }, {
    "itemIndex": 2,
    "componentId": 1122,
  }],
  "isInNeuralNetwork": false,
  ...
  "components": [{ "itemIndex": 1, "componentId": 60 }, {
    "itemIndex": 2,
    "componentId": 1122,
  }, { "itemIndex": 3, "componentId": 28 }],
  "isInNeuralNetwork": false,
  "isFullItemHeroPurchaseItem": false,
}, {
  "id": 1107,
  ...
  "language": {
    ...
    "lore": [],
    "description": [
      "<h1>Passive: Empower Spell</h1> The next Unit Target spell you cast on an enemy deals a separate %bonus_spell_damage% bonus damage to the target, and slows them by %slow%%% for %slow_duration%s.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "lore": [],
    "description": [
      "<h1>Use: Throw Grenade</h1> Throw a grenade at the target area. Enemies in the area will take %impact_damage% damage on impact, and be slowed by %movespeed_slow%%% and take %damage_over_time% damage every %tick_rate%s for %debuff_duration% seconds. Radius %radius%. ",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "lore": [],
    "description": [
      "<h1>Passive: Courage</h1> Provides %damage% damage when the hero is above %health_pct%%% Health, and %armor% armor when they are below that threshold.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "lore": [],
    "description": [
      "<h1>Active: Protect</h1> When cast on an ally, grants them a physical damage barrier that absorbs %absorb_amount% damage. Duration: %duration%s <br><br>Range: %abilitycastrange%",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Eternal Chains</h1>Roots all enemies in a target %radius% radius for %duration% seconds and deals %active_damage% damage.<br><br>Range: %abilitycastrange% ",
      "",
      "<h1>Passive: Chain Lightning</h1>Grants a %chain_chance%%% chance on attack to release a bolt of electricity that leaps between %chain_strikes% targets within a %chain_radius% radius, dealing %chain_damage% magical damage to each. Lightning proc pierces evasion.",
    ],
    "notes": [],
  ...
  "language": {
    ...
    "lore": [],
    "description": [
      "<h1>Passive: Vengeance</h1> Provides %bonus_damage% damage if equipped hero is Silenced and %bonus_armor% armor if equipped hero is Stunned.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "lore": [],
    "description": [
      "<h1>Passive: Boldness</h1> Grants %bonus_attack_speed% attack speed as long as there are enemy heroes within %radius% units.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "lore": [],
    "description": [
      "<h1>Passive: Equilibrium</h1> Damage dealt to and received from units further than %distance% units from you is reduced by %damage_reduction%%%.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "lore": [],
    "description": [
      "<h1>Passive: Toxins</h1> Whenever an enemy attacks you, they gain -%heal_reduction% Heal Amplify/Lifesteal amplification for 3 seconds.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "lore": [],
    "description": [
      "<h1>Passive: Magical Damage Block</h1> Every %AbilityCooldown%s, blocks up to %magic_block% magic damage from damage instances over %min_damage% damage.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "lore": [],
    "description": [
      "<h1>Active: Turtle</h1> Silences and Disarms your hero for %duration% seconds. Reduce all incoming damage by %damage_reduction%%%. This effect is removed when your hero moves.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "lore": [],
    "description": [
      "<h1>Active: Martyrdom</h1> Redirect %damage_redirection%%% of all damage dealt to your allied heroes within %aura_radius% radius towards you for %duration% seconds.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "lore": [],
    "description": [
      "<h1>Passive: Sixth Sense</h1> Automatically dodge an attack from an enemy hero.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "lore": [],
    "description": [
      "<h1>Use: Eat Lotus</h1> Instantly restores %replenish_amount% health and mana.<br><br>Range: %abilitycastrange%",
    ],
    "notes": ["Hold Control to use on a nearby allied hero."],
    "attributes": [],
  },
  ...
  "language": {
    "displayName": "Recipe: Great Healing Lotus",
    "lore": [],
    "description": [],
    "notes": [],
    "attributes": [],
  ...
  "components": [{ "itemIndex": 1, "componentId": 4204 }, {
    "itemIndex": 2,
    "componentId": 4204,
  }, { "itemIndex": 3, "componentId": 4204 }],
  "isInNeuralNetwork": false,
  "isFullItemHeroPurchaseItem": false,
}, {
  "id": 4208,
  ...
  "language": {
    "displayName": "Recipe: Greater Healing Lotus",
    "lore": [],
    "description": [],
    "notes": [],
    "attributes": [],
  ...
  "components": [{ "itemIndex": 1, "componentId": 4205 }, {
    "itemIndex": 2,
    "componentId": 4205,
  }],
  "isInNeuralNetwork": false,
  ...
  "language": {
    "displayName": "Beloved Memory",
    "lore": [
      "Take joy in remembering those beloved who've passed now beyond the veil.",
    ],
    "description": [
      "<h1>Active: Honor the Dead</h1>Place this Offering on an Altar to honor the dead with a memory from those they left behind.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    "displayName": "Scrying Shovel",
    "lore": [
      "You don't know where it came from, but it knows where you need to go. All you need to do is dig.",
    ],
    "description": [
      "<h1>Active: Dig</h1>Search the map for Offerings to the dead.",
    ],
    "notes": [],
    "attributes": [],
  },
  ...
  "language": {
    ...
    "description": [
      "<h1>Active: Undying Promise</h1>Signal to the spirits of the other realm your commitment to honoring them. If everyone in the battle makes an Undying Promise before the fight begins, the dead might be willing to listen.",
    ],
    "notes": [],
    "attributes": [],
  },
